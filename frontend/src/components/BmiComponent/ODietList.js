...
class OverDietList extends Component {
  render() {
    return (
      <div>
        <div class="lybMar-btm lybMar-top">
  <table>
    <tbody>
      <tr>
        <td  colspan="2">
      ...
      <tr>
        <td width="20%">Breakfast (8:00-8:30AM)</td>
        <td>
          3 egg whites + 1 toasted brown bread + 1/2 cup low fat milk (no sugar)
        </td>
      </tr>
      <tr>
        <td width="20%">Mid-Meal (11:00-11:30AM)</td>
        <td>1 cup papaya</td>
      </tr>
      <tr>
        <td width="20%">Lunch (2:00-2:30PM)</td>
        <td>1 cup arhar dal + 1 chapatti + 1/2 cup low fat curd + salad</td>
      </tr>
      <tr>
        <td width="20%">Evening (4:00-4:30PM)</td>
        <td>1 cup vegetable soup</td>
      </tr>
      <tr>
        <td width="20%">Dinner (8:00-8:30PM)</td>
